defmodule MovieApi.Likes do
  ...
  """
  def get_like!(id), do: Repo.get!(Like, id) |> Repo.preload(:user) |> Repo.preload(:post)

  def get_likes_by_post(post_id) do
    Repo.all(from l in Like, where: l.post_id == ^post_id) |> Repo.preload(:user) |> Repo.preload(:post)
  end
